    ...
    <div class="padding_right">
        ...
        <div class="row shop_info_row">
            ...
            <div class="col-md-2 col-md-offset-0 col-xs-5  level_choose_btn">
                ...
                <div class="row dropdown">
                    {!! Form::select('education', array(0 => 'انتخاب کنید', 'بی سواد' => 'بی سواد', 'زیر دیپلم' => 'زیر دیپلم', 'دیپلم' => 'دیپلم', 'کاردانی' => 'کاردانی', 'کارشناسی' => 'کارشناسی', 'کارشناسی ارشد' => 'کارشناسی ارشد', 'دکترا' => 'دکترا', 'دکترا به بالا' => 'دکترا به بالا'), null, ['class'=>'selectpicker', 'tabindex'=>'5']) !!}
                </div>
            </div>
        ...
        <div class="row shop_info_row">
            ...
            <div class="col-md-3 col-md-offset-0 col-xs-5  input_box_user level_choose_btn">
                ...
                <div class="row dropdown">
                    {!! Form::select('city', ["$admin->city" =>"$admin->city"], null, ['class'=>'btn_choose', 'tabindex'=>'7']) !!}
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                {!! Form::submit('به روز رسانی ادمین', ['class'=>'btn makeUser_btn']) !!}
            </div>
        </div>
        {!! Form::close() !!}
    </div>
