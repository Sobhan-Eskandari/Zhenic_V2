            ...
            <div class="">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav pull-right navbar-right">
                        ...
                        <li class="enter_btn pull-right"><a class="navbar-brand pull-right" href="{{url('/login')}}">ورود</a></li>
                    </ul>
...
{{--<body>--}}
{{--navbar--}}
{{--<div class="container-fluid ok_height">--}}
    {{--<div class="row">--}}
        {{--<nav class="navbar navbar-inverse navbar-fixed-top">--}}
            {{--<div class="container-fluid">--}}
                ...
                {{--<div class="collapse navbar-collapse" id="myNavbar">--}}
                    {{--<!--navbar menu-->--}}
                    {{--<ul class="nav navbar-nav navbar-right all">--}}
                        {{--<li>--}}
                            {{--<a>--}}
                                {{--<div class="btn-group">--}}
                                    {{--<input class="form-control inputSearch nav_up" type="text" id="inputSearch" placeholder="جستجو">--}}
                                    {{--<button type="button" class="btn search_nav"><span class="glyphicon glyphicon-search"></span></button>--}}
                                {{--</div>--}}
                            {{--</a>--}}
                        {{--</li>--}}

                        {{--<li class="main_navbar enter_navbar_btn"><a href="{{ url('/login') }}">ورود</a></li>--}}
                        {{--<li class="main_navbar menu_item"><a href="#">تماس با ما</a></li>--}}
                        {{--<li class="main_navbar menu_item"><a href="aboutZhenic.html">درباره ما</a></li>--}}
                        {{--<li class="main_navbar menu_item"><a href="Post.html">فروشگاه ها</a></li>--}}
                        {{--<li class="main_navbar menu_item home_nav"><a href="homePage.html">خانه</a></li>--}}
                    {{--</ul>--}}
                {{--</div>--}}
            {{--</div>--}}
        {{--</nav>--}}
