...
class UserEditRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'first_name'=>'required',
            'last_name'=>'required',
            'social_security_number'=>'required|digits:10|unique:users,social_security_number,'.$this->customer,
            'education'=>'nullable',
            'occupation'=>'nullable',
            'state'=>'required',
            'city'=>'required',
            ...
            'bank_name'=>'required',
            'bank_card_number'=>'required|digits:16',
            'bank_account_number'=>'required|numeric',
            'zhenic_card_number'=>'required|numeric|unique:users,zhenic_card_number,'.$this->customer,
